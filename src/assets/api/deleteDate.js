...
export const deleteDate = function(offset = 1) {
    ...
    var futureDate = []
    for (var num = offset; num <= 31; num++) {
        futureDate.push(add(new Date(), { days: num }))

    }

    futureDate.push.apply(futureDate, dateArray.map(x => new Date(new Date(x).getTime() + 86400 * 1000)));
    return futureDate
